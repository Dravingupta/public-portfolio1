...
function ProjectCard({ project, index }) {
    return (
        <motion.div
            ...
            className="h-full"
        >
            <TiltCard className="glass-effect p-6 rounded-xl hover:border-neon-blue transition-all duration-300 group h-full flex flex-col">
                <div className="flex items-start justify-between mb-4" style={{ transform: "translateZ(20px)" }}>
                    ...
                    {project.featured && (
                        <span className="px-3 py-1 text-xs bg-neon-purple/20 text-neon-purple border border-neon-purple rounded-full">
                            Featured
                        </span>
                    )}
                </div>
                ...
                <div className="flex space-x-4" style={{ transform: "translateZ(30px)" }}>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-neon-pink hover:text-white transition-colors flex items-center space-x-2"
                    >
    ...
    return (
        <section id="projects" className="min-h-screen py-20 px-4 relative">
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <motion.h2
                    className="text-4xl md:text-5xl font-bold mb-12 text-center text-glow text-neon-purple"
